...
import { AgentArgumentCard, ArgumentFullView } from "./AgentArgumentCard";
import { Modal } from "@/components/ui/Modal";
import type { DebateRound, DebateArgument } from "@/lib/agents/types";
...
export function DebateTimeline({ rounds, currentRound }: DebateTimelineProps) {
  ...
  const [selectedArgument, setSelectedArgument] = useState<DebateArgument | null>(null);
  ...
  return (
    <>
      ...
      {/* Full argument modal */}
      <Modal
        isOpen={selectedArgument !== null}
        onClose={() => setSelectedArgument(null)}
        size="xl"
      >
        {selectedArgument && <ArgumentFullView argument={selectedArgument} />}
      </Modal>
    </>
  );
}
